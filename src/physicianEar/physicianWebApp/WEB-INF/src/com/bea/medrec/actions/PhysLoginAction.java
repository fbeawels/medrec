 ...
 */
public class PhysLoginAction extends BaseAction implements PhysicianConstants {

  private static Logger logger =
      MedRecLog4jFactory.getLogger(PhysLoginAction.class.getName());
  ...
  private ActionForward authenticate(UserBean user,
    ...
    if (auth == ServletAuthentication.AUTHENTICATED) {
      ...
      // Hardcoding name.  User lookup functionality has been intentionally
      // left out of the physician application.
      PhysicianBean physician = new PhysicianBean("Mary", "Blige", user.getUsername());
      session.setAttribute(PHYSICIAN_BEAN, physician);
