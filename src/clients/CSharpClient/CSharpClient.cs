...
namespace CSharpClient
{
	...
	public class WindowsClient : System.Windows.Forms.Form
	{
		...
		private localhost.Patient thePatient = null;		
		...
		private void InitializeComponent()
		{
			...
			this.wsdlTextBox.Text = "http://localhost:7101/ws_medrec/MedRecWebServices?WSDL";
		...
		private void mapPatientProfile() 
		{
			...
			this.dateOfBirthTextBox.Text = this.thePatient.DateOfBirth.ToShortDateString();
			...
			localhost.Address address = this.thePatient.Address;
		...
		private void submitButton_Click(object sender, System.EventArgs e)
		{
			...
			try 
			{
				...
				localhost.Patient patient = proxy.findPatientBySsn(this.SSNEntryTextBox.Text);
		...
		private void saveChangesButton_Click(object sender, System.EventArgs e) {
			...
			try {
				...
				localhost.Address address = new localhost.Address();
				address.StreetName1 = this.streetName1TextBox.Text;
				address.StreetName2 = this.streetName2TextBox.Text;
				address.City = this.cityTextBox.Text;
				address.State = this.stateTextBox.Text;
				address.ZipCode = this.zipCodeTextBox.Text;
				address.Country = this.countryTextBox.Text;
				
				localhost.Patient patient = new localhost.Patient();
				patient.Id = this.thePatient.Id;
				patient.Address = address;
				patient.FirstName = this.firstNameTextBox.Text;
				patient.LastName = this.lastNameTextBox.Text;
				patient.MiddleName = this.middleNameTextBox.Text;
				patient.DateOfBirth = System.DateTime.Parse(this.dateOfBirthTextBox.Text);
				patient.Gender = this.genderTextBox.Text;
				patient.Phone = this.phoneTextBox.Text;
				patient.Email = this.emailTextBox.Text;
				patient.Ssn = this.socialSecurityTextBox.Text;
