  ...
  private void mapPatientProfile() {
    if (this.thePatient != null) {
      ...
      if (this.thePatient.getDateOfBirth() != null) {
        dateOfBirth_textfield.setText(Utils.getDisplayDate(this.thePatient.getDateOfBirth()));
      }
      ...
      if (this.thePatient.getAddress() != null) {
        Address Address = this.thePatient.getAddress();
        this.streetName1_textfield.setText(Address.getStreetName1());
        this.streetName2_textfield.setText(Address.getStreetName2());
        this.city_textfield.setText(Address.getCity());
        this.state_textfield.setText(Address.getState());
        this.zipcode_textfield.setText(Address.getZipCode());
        this.country_textfield.setText(Address.getCountry());
      }
    }
  }
  ...
  */
  ...
  void saveButton_actionPerformed(ActionEvent e) {
    ...
    try {
      ...
      address.setCity(this.city_textfield.getText());
      address.setCountry(this.country_textfield.getText());
      address.setId(this.thePatient.getAddress().getId());
      address.setState(this.state_textfield.getText());
      address.setStreetName1(this.streetName1_textfield.getText());
      address.setStreetName2(this.streetName2_textfield.getText());
      address.setZipCode(this.zipcode_textfield.getText());
      ...
      patient.setEmail(this.email_textfield.getText());
      patient.setFirstName(this.firstName_textfield.getText());
      patient.setGender(this.gender_textfield.getText());
      patient.setId(this.thePatient.getId());
      patient.setLastName(this.lastName_textfield.getText());
      patient.setMiddleName(this.middleName_textfield.getText());
      patient.setPhone(this.phone_textfield.getText());
      patient.setSsn(this.ssn_textfield.getText());
