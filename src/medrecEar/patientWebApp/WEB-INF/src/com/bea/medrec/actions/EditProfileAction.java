...
public class EditProfileAction extends PatientBaseLookupDispatchAction {
  private static Logger logger =
      MedRecLog4jFactory.getLogger(EditProfileAction.class.getName());
  ...
  public ActionForward save(ActionMapping mapping,
    ...
    origPatient = (PatientBean)getSessionAttribute(request, PATIENT_BEAN);
    ...
    setSessionAttribute(request, PATIENT_BEAN, newPatient);
