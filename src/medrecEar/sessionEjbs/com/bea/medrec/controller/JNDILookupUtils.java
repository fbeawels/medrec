...
public class JNDILookupUtils {
  ...
  /**
   * <p>Get Physician Entity EJB local home.</p>
   *
   * @return PhysicianLocalHome
   * @throws NamingException
   */
  public static PhysicianLocalHome getPhysicianLocalHome() throws NamingException {
  ...
  /**
   * <p>Get Prescription Entity EJB local home.</p>
   *
   * @return PrescriptionLocalHome
   * @throws NamingException
   */
  public static PrescriptionLocalHome getPrescriptionLocalHome()
      throws NamingException {
