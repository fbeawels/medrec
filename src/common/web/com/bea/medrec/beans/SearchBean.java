...
public final class SearchBean extends BaseBean {
  private static Logger logger = MedRecLog4jFactory.getLogger(SearchBean.class.getName());
  ...
  /**
   * <p>Validate search.  Due to the complexity of the input fields, this
   * bean requires manual validation verus Struts' validation.</p>
   *
   * @return ActionErrors
   */
