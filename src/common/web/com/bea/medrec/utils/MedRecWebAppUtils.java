...
public class MedRecWebAppUtils {
  ...
  private static Logger logger =
      MedRecLog4jFactory.getLogger(MedRecWebAppUtils.class.getName());

  private static MedRecWebAppUtils instance;

  private MedRecWebAppUtils() { }
   ...
   */
  public static MedRecWebAppUtils getInstance() {
    if (instance == null) instance = new MedRecWebAppUtils();
    return instance;
  }
  ...
  * @return String
  */
  public static String col2Str(Collection col) {
    StringBuffer str = new StringBuffer();
    if (col != null && !col.isEmpty()) {
      str.append(" Num of "+col.getClass().getName()+": "+col.size()+" |");
  ...
  * <p>Print collection contents.</p>
  *
  * @param pObjArray Array
  * @return String
  */
  public static String array2Str(Object[] pObjArray) {
    StringBuffer str = new StringBuffer();
    if (pObjArray != null && pObjArray.length > 0) {
      str.append(" Num of "+pObjArray.getClass().getName()+
          ": "+pObjArray.length+" |");
      for (int i=0; i<pObjArray.length; i++) {
        Object obj = pObjArray[i];
        str.append(" "+obj.toString());
      }
    }
    else {
      str.append(pObjArray.getClass().getName()+": [null]");
    }
    return str.toString();
  }
  ...
  */
  public static Throwable getRootError(Throwable th) {
    if (th instanceof javax.ejb.EJBException) {
      ...
      || th instanceof java.rmi.AccessException
      || th instanceof java.sql.SQLException
      || th instanceof com.bea.medrec.exceptions.MedRecException) {
